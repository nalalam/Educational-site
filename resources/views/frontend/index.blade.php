...
@section('title')
    <title> HTML to Blade convertion </title>
@endsection
...
@section('body')
    <!--=================================
        BANNER START
    ==================================-->
    <section class="tf__banner" style="background: url({{ asset('frontend/images/banner_bg.jpg') }});">
        <div class="container">
            <div class="row">
    ...
    <!--=================================
        ABOUT START
    ==================================-->
    <section class="tf__about mt_250 xs_mt_195" style="background: url({{ asset('frontend/images/about_bg.png') }});">
        <div class="container">
            <div class="tf__about_top wow fadeInUp" data-wow-duration="1.5s"
                style="background: url({{ asset('frontend/images/about_top_bg.jpg') }});">
                <div class="row">
                    <div class="col-xl-5 col-lg-5">
                        <div class="tf__about_top_img">
                            <img src="{{ asset('frontend/images/about_top_img.jpg') }}" alt="about" class="img-fluid w-100">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-sm-9 col-md-8 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
                    <div class="tf__about_img">
                        <img src="{{ asset('frontend/images/about_img.png') }}" alt="about" class="img-fluid w-100">
                        <div class="text">
        ...
        <div class="container">
            ...
            <div class="row event_slider">
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_event">
                        <div class="tf__single_event_img">
                            <img src="{{ asset('frontend/images/event_img_1.jpg') }}" alt="event" class="img-fluid w-100">
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_event">
                        <div class="tf__single_event_img">
                            <img src="{{ asset('frontend/images/event_img_2.jpg') }}" alt="event" class="img-fluid w-100">
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_event">
                        <div class="tf__single_event_img">
                            <img src="{{ asset('frontend/images/event_img_3.jpg') }}" alt="event" class="img-fluid w-100">
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_event">
                        <div class="tf__single_event_img">
                            <img src="{{ asset('frontend/images/event_img_4.jpg') }}" alt="event" class="img-fluid w-100">
    ...
    <!--=================================
        FAQ START
    ==================================-->
    <section class="tf__faq mt_100 pt_95 xs_pt_100 pb_100" style="background: url({{ asset('frontend/images/faq_bg.png') }});">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1.5s">
                    <div class="tf__faq_img">
                        <img src="{{ asset('frontend/images/faq_img.jpg') }}" alt="faqs" class="img-fluid w-100">
                    </div>
                </div>
    ...
    <!--=================================
        WORK START
    ==================================-->
    <section class="tf__work pt_95" style="background: url({{ asset('frontend/images/work_bg.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-md-8 col-lg-6 m-auto wow fadeInUp" data-wow-duration="1.5s">
            ...
            <div class="row work_slider">
                <div class="col-xl-4">
                    <div class="tf__work_single blue">
                        <div class="tf__work_single_img">
                            <img src="{{ asset('frontend/images/work_img_1.jpg') }}" alt="work" class="img-fluid w-100">
                        </div>
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__work_single orange">
                        <div class="tf__work_single_img">
                            <img src="{{ asset('frontend/images/work_img_2.jpg') }}" alt="work" class="img-fluid w-100">
                        </div>
                        <div class="tf__work_single_text">
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__work_single green">
                        <div class="tf__work_single_img">
                            <img src="{{ asset('frontend/images/work_img_3.jpg') }}" alt="work" class="img-fluid w-100">
                        </div>
                        <div class="tf__work_single_text">
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__work_single red">
                        <div class="tf__work_single_img">
                            <img src="{{ asset('frontend/images/work_img_4.jpg') }}" alt="work" class="img-fluid w-100">
                        </div>
                        <div class="tf__work_single_text">
                            <h3>Classes Completed</h3>
                            <p>We can provide you with a reliable handyan in London. you need to included the today.</p>
    ...
    <!--=================================
        TESTIMONIAL START
    ==================================-->
    <section class="tf___testimonial mt_100 pt_95 pb_100" style="background: url({{ asset('frontend/images/testimonial_bg.jpg') }});">
        <div class="container">
            <div class="row">
            ...
            <div class="row testimonial_slider">
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_testimonial">
                        ...
                        <div class="img">
                            <img src="{{ asset('frontend/images/client_img_1.png') }}" alt="client" class="img-f;uid w-100">
                        </div>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_testimonial">
                        ...
                        <p class="description">There are many variations of passages of Lorem Ipsum available, but the
                            majority have suffered alteration in some form by injected humour</p>
                        <div class="img">
                            <img src="{{ asset('frontend/images/client_img_2.png') }}" alt="client" class="img-f;uid w-100">
                        </div>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_testimonial">
                        ...
                        <p class="description">There are many variations of passages of Lorem Ipsum available, but the
                            majority have suffered alteration in some form by injected humour</p>
                        <div class="img">
                            <img src="{{ asset('frontend/images/client_img_3.png') }}" alt="client" class="img-f;uid w-100">
                        </div>
                        <h3 class="title">Borata Mara</h3>
                        <p class="designation">Devlopment</p>
                        <p class="rating">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-9 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
                    <div class="tf__activities_img">
                        <img src="{{ asset('frontend/images/activities_img.jpg') }}" alt="activities" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--=================================
        VIDEO START
    ==================================-->
    <section class="tf__video mt_100" style="background: url({{ asset('frontend/images/video_bg.jpg') }});">
